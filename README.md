...
## Binaries [![Build status](https://ci.appveyor.com/api/projects/status/m10omc99w5xphdry?svg=true)](https://ci.appveyor.com/project/osospeed/juicy-potato)
 An automatic build is available. Binaries can be downloaded from the Artifacts section [here](https://ci.appveyor.com/project/osospeed/juicy-potato/build/artifacts).
